<template>
  <q-page class="column q-mx-auto" :padding="true" style="max-width: 900px;">
    ...
    <ul>
      ...
      <li>
        <p><strong>Application</strong> refers to Frog, the software program provided by the Company.</p>
      </li>
      <li>
        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or
          &quot;Our&quot; in this Agreement) refers to Tender Owl.</p>
      </li>
      <li>
  ...
  <ul>
    <li>
      <p>By email: andrey@tenderowl.com</p>
    </li>
    <li>
      <p>By visiting this page on our website: <a class="text-primary" href="https://github.com/tenderowl/frog/issues"
          rel="external nofollow noopener" target="_blank">https://github.com/tenderowl/frog/issues</a></p>
    </li>
  </ul>
</q-page></template>
...
<style lang="scss" scoped>.width-960 {
  max-width: 960px;
}</style>
